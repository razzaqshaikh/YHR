  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
    ...
    <body>
        <table class="table table-striped">
            <tr><th>HomeRemedy Id<th>Disease Name<th>Description(if any)<th>Youtube Link</tr>
  <%
  try
    {
        ...
        String q="select * from homeremedies";
        ...
        while(rs.next())
        {
          ...
          out.println("<td><a href="+rs.getString(4)+" target=__blank>"+rs.getString(2)+"</a>");
