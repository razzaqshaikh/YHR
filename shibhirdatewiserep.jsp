...
<html>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
    ...
    <body> <h2><p align="center"><font color="red">Date-wise Shibhir Booking Report</p></h2>
        <form action="shibhirdatewiserep.jsp">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <%
                        ...
                        ResultSet rs=st.executeQuery("select distinct(fromd) from book");
                ...
                <div class="col-lg-4">
                    <%
                        ...
                        ResultSet rs1=st1.executeQuery("select distinct(tod) from book");
  ...
  try
    {
        ...
        String q="select * from book where fromd="+aa+" and tod="+bb+"";
        //out.println(q);
